...
public class ScrollPickerView extends RecyclerView {
    ...
    public void doDraw(Canvas canvas) {
        if (mItemHeight > 0) {
            ...
            int startX = screenX / 2 - mItemWidth / 2 - ScreenUtil.dip2px(context,5);
            int stopX = mItemWidth + startX + ScreenUtil.dip2px(context,5);
    ...
    private void initPaint() {
        if (mBgPaint == null) {
            ...
            mBgPaint.setStrokeWidth(ScreenUtil.dip2px(context,1f));
        }
    }
    ...
    private int getLineColor() {
        ...
        return getResources().getColor(R.color.textline);
    }
